...
import OrderbillSelect from '../../InteComponets/OrderbillSelect'
import PlanitemSelect from '../../InteComponets/PlanitemSelect'

//OrderbillSelect 支持属性：
...
export default class TestOrderbill extends Component {
  constructor(props) {
    super();
    this.state = {
      dataSource: []
    ...
    return (
      <div className="home-container code-box">
        <Table columns={columns}
          ...
          />
        <hr />
        <OrderbillSelect width='1200' addTableData={this.addTableData.bind(this)} maskClosable buttonName='从订单明细中添加'/>
        <br/>
